...
inherit eutils git-r3 ruby-single systemd tmpfiles
...
DEPEND="
	...
	>=dev-vcs/gitlab-shell-14.13.0[relative_url=]
	pages? ( ~www-apps/gitlab-pages-15.6.3 )
...
src_install() {
	...
	local file gem wwfgems="toml-rb"
